    ...
    const baseDeDatos = [
        {
            ...
            nombre: 'Dona',
            precio: 3500,
            imagen: '/menu/img/donas.jpg'
        },
        {
            id: 2,
            nombre: 'Cupcake',
            precio: 3000,
            imagen: '/menu/img/Cupcake.jpg'
        },
        {
            id: 3,
            nombre: 'Pan Francés',
            precio: 4500,
            imagen: '/menu/img/PanFrances.jpg'
        },
        {
            id: 4,
            nombre: 'Batido',
            precio: 2500,
            imagen: '/menu/img/Batido.jpg'
        },

        {
            ...
            nombre: 'Café',
            precio: 1500,
            imagen: '/menu/img/cafe.jpg'
        },
        {
            id: 6,
            nombre: 'Chocolate',
            precio: 2000,
            imagen: '/menu/img/chocolate.jpg'
        }
    ];
